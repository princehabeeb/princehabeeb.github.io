                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                       <div class="contact-btn contact-2-btn text-center">
                                            <button class="btn btn-block" type="submit"><span class="btn-text">Login <i
                                                        class="far fa-long-arrow-right"></i></span> <span
                                                    class="btn-border"></span></button>
                                        </div>
                                    </div>
                                    <div class="col-12 mt-5">
                                        <p class="text-center"><b>Dont Have An Account? <a href="register" class="text-primary">Register Now</a></b></p>
